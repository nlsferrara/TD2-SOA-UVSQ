...
@app.post("/extract-information", response_model=str)
def extract_information(xml_data: str = Body()):
    
    informations_structurees = ExtractionInfo(xml_data)
    
    nom_client = stockage_information(informations_structurees)

    # Retrieve the XML database for the specified client
